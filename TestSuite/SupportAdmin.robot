...
Create and Register new Member
    Log    ${new_member}
    &{new_member}=    Create Dictionary    firstName=Test${COUNTER}    middleName=mid    lastName=User${COUNTER}
    ...    email=testuser0${COUNTER}@getnada.com    password=testuser@${COUNTER}    phone=991122330${COUNTER}    dateOfBirth=01-01-1990
...
Invite a Member as Admin to Org
    ...
    Invite a Member to Org    ${ids_to_Invite}    ${role_admin}    ${created_org_id}
